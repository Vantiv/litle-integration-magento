...
public function processResponse(Varien_Object $payment,$litleResponse){
	...
	public function authorize(Varien_Object $payment, $amount)
	{
		...
		if (!empty($order)){
			...
			$data = array(
				...
				'funding_source'=> Litle_CreditCard_Model_PaymentLogic::formatFundingSource(XMLParser::getNode($litleResponse, 'type')),
				...
				'reloadable' => Litle_CreditCard_Model_PaymentLogic::formatReloadable(XMLParser::getNode($litleResponse, 'reloadable')),
			);
	...
	{
		return Litle_CreditCard_Model_PaymentLogic::formatMoney($balance);
	}
	...
	static public function formatFundingSource($prepaid) {
		...
		return Litle_CreditCard_Model_PaymentLogic::capitalize($prepaid);
	}
	
	static public function formatPrepaidCardType($prepaidCardType) {
		return Litle_CreditCard_Model_PaymentLogic::capitalize($prepaidCardType);
	}
	
	static public function formatReloadable($reloadable) {
		return Litle_CreditCard_Model_PaymentLogic::capitalize($reloadable);
	}
